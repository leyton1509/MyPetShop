...
/**
 * Crocodile class extending the pet class
 */
...
public class Crocodile extends Pet{
    ...
    public Crocodile(String _animalName, String _animalClass, int _animalAge, String _ownerName, float _animalWeight, String _animalColour){
